...
from .configuration_smamba import StripedMambaConfig
...
_CONFIG_FOR_DOC = "StripedMambaConfig"
...
class MambaWrapper(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.mamba = Mamba(d_model=config.hidden_size,
    ...
    def forward(self,
        ...
        return (self.mamba(hidden_states), None, None)
...
class StripedMambaPreTrainedModel(PreTrainedModel):
    ...
    _no_split_modules = ["StripedMambaLayer"]
...
class StripedMambaLayer(nn.Module):
    def __init__(self, config):
        super().__init__()
        ...
        self.attention = MambaWrapper(config)
...
class StripedMambaModel(StripedMambaPreTrainedModel):
    def __init__(self, config):
        ...
        self.layers = nn.ModuleList([StripedMambaLayer(config) for _ in range(config.num_hidden_layers)])
...
class StripedMambaForCausalLM(StripedMambaPreTrainedModel):
    _tied_weights_keys = ["embed_out.weight"]

    def __init__(self, config):
        super().__init__(config)

        self.gpt_neox = StripedMambaModel(config)

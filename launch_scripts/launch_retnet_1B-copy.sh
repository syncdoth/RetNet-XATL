...
launcher="echo n | sudo -E env "PATH=$PATH" lightning run model \
    --node-rank=$RANK  \
...
args="$args --copy_model_path checkpoints/pythia-1b-deduped/retnet/lit_model-$MODE.bin"
